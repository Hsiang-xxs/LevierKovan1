...
export class ComptrollerProxy extends ethereum.SmartContract {
  static bind(address: Address): ComptrollerProxy {
    return new ComptrollerProxy("ComptrollerProxy", address);
  }
